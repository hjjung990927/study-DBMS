...
create table tbl_post(
	...
	post_writetime varchar(255) not null,
...
create table tbl_car_owner(
	...
	car_owner_phone varchar(255),
	car_owner_address varchar(255)
);
...
create table tbl_category_a(
	id bigint unsigned primary key,
	category_a_name varchar(255)
);

create table tbl_category_b(
	id bigint unsigned primary key,
	category_b_name varchar(255),
...
create table tbl_kindergarten(
	...
	kindergarten_phone varchar(255) not null,
	member_id bigint unsigned,
...
create table tbl_field_trip(
	...
	field_trip_event_image varchar(255) not null,
...
create table tbl_apply(
	id bigint unsigned primary key,
	apply_check enum('selected', 'none') default 'none',
	field_trip_id bigint unsigned,
...
create table tbl_advertising_company(
	id bigint unsigned primary key,
	advertising_company_name varchar(255),
	advertising_company_address varchar(255),
	advertising_company_call varchar(255)
);
...
create table tbl_advertisement(
	...
	advertising_company_id bigint unsigned,
	constraint fk_advertisement_advertising_company foreign key(advertising_company_id)
	references tbl_advertising_company(id)
);
...
create table tbl_client_company(
	...
	client_company_call varchar(255),
	client_company_type_check enum('스타트업', '중소기업', '중견기업', '대기업')
);

create table tbl_choice(
	id bigint unsigned primary key,
	choice_check enum('category_A', 'category_B', 'category_C'),
	client_company_id bigint unsigned,
	advertisement_id bigint unsigned,
	constraint fk_choice_client_company foreign key(client_company_id)
	references tbl_client_company(id),
	constraint fk_choice_advertisement foreign key(advertisement_id)
	references tbl_advertisement(id)
);
...
create table tbl_winner(
	id bigint unsigned primary key,
	winner_drink_code varchar(255) not null,
...
create table tbl_drink(
	...
	drink_price int,
	drink_stock int default 0,
	drink_code varchar(255) not null,
	product_id bigint unsigned,
	constraint fk_drink_product foreign key(product_id)
	references tbl_product(id)
);

create table tbl_winning(
	id bigint unsigned primary key,
	winning_code varchar(255) unique not null,
	winning_goods varchar(255) not null,
	winning_goods_delivery enum('배송중', '배송완료') default '배송중',
	drink_id bigint unsigned,
	constraint fk_winning_drink foreign key(drink_id)
	references tbl_drink(id)
);

create table tbl_check_winning(
	id bigint unsigned primary key,
	winning_id bigint unsigned,
	drink_id bigint unsigned,
	winner_id bigint unsigned,
	constraint fk_check_winning_winning foreign key(winning_id)
	references tbl_winning(id),
	constraint fk_check_winning_drink foreign key(drink_id)
	references tbl_drink(id),
	constraint fk_check_winning_winner foreign key(winner_id)
...
create table tbl_ecommerce_company(
	id bigint unsigned primary key,
	ecommerce_company_name varchar(255) not null,
	ecommerce_company_address varchar(255) not null,
	ecommerce_company_call varchar(255) not null
);

create table tbl_ecommerce_user(
	id bigint unsigned primary key,
	ecommerce_user_name varchar(255) not null,
	ecommerce_user_address varchar(255) not null,
	ecommerce_user_phone varchar(255) not null
);

create table tbl_cart(
	id bigint unsigned primary key,
	cart_product_name varchar(255) not null,
	cart_product_stock int not null,	
	ecommerce_user_id bigint unsigned unique,
	constraint fk_cart_ecommerce_user foreign key(ecommerce_user_id)
	references tbl_ecommerce_user(id)
);

create table tbl_ecommerce_product(
	id bigint unsigned primary key,
	ecommerce_product_name varchar(255) not null,
	ecommerce_product_price int not null,
	ecommerce_product_stock int,
	ecommerce_company_id bigint unsigned,
	constraint fk_ecommerce_product_ecommerce_company foreign key(ecommerce_company_id)
	references tbl_ecommerce_company(id)
);

create table tbl_register_card(
	id bigint unsigned primary key,
	register_card_number int not null,
	register_card_company varchar(255) not null,
	ecommerce_user_id bigint unsigned,
	constraint fk_registered_card_ecommerce_user foreign key(ecommerce_user_id)
	references tbl_ecommerce_user(id)
);

create table tbl_payment(
	id bigint unsigned primary key,
	ecommerce_product_id bigint unsigned,
	register_card_id bigint unsigned,
	constraint fk_payment_ecommerce_product foreign key(ecommerce_product_id)
	references tbl_ecommerce_product(id),
	constraint fk_payment_register_card foreign key(register_card_id)
	references tbl_register_card(id)
);

create table tbl_review(
	id bigint unsigned primary key,
	review_grade int check(review_grade between 1 and 5) default 1,
...
create table tbl_delivery(
	id bigint unsigned primary key,
	delivery_check enum('배송 준비중', '배송 중', '배송 완료') default '배송 준비중',
	delivery_startdate date not null,
	delivery_arrivedate date not null,
...
create table tbl_refund(
	...
	refund_check enum('요청됨', '승인됨', '반품 완료', '거절됨') default '요청됨',
	payment_id bigint unsigned unique,
